...
export function PaymentSlipPrint({
  customer,
  subscription,
  businessName,
  businessPhone,
    ...
    <div className="space-y-4">
      ...
      >
        ...
        <div className="mb-6 text-center print:hidden">
          <p className="text-sm text-secondary-600 mb-2">{t('common.or', { defaultValue: 'أو' })}</p>
          <QRCodeDisplay value={subscription.subscriptionCode} size={150} className="mx-auto" />
        </div>
